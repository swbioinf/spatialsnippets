...
It's highly recommended to check out the paper [Confronting false discoveries in single-cell differential expression](https://www.nature.com/articles/s41467-021-25960-2)[@squairConfrontingFalseDiscoveries2021], which outlines the importance of replicates, benchmarking of different scRNAseq differenetial expression tools and common biases in results.
...
* [Confronting false discoveries in single-cell differential expression](https://www.nature.com/articles/s41467-021-25960-2)[@squairConfrontingFalseDiscoveries2021] : This is an excellent paper benchmarking and exploring differental expression methods for single cell expression data.
