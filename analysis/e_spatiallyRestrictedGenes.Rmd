...
1. Subset each tissue 
2. Calculate moransI for each sample
...
Paper [Microglia-astrocyte crosstalk in the amyloid plaque niche of an Alzheimer’s disease mouse model, as revealed by spatial transcriptomics](https://www.sciencedirect.com/science/article/pii/S2211124724005448?via%3Dihub)[@mallachMicrogliaastrocyteCrosstalkAmyloid2024]
...
We will look for _spatially_ variable features on each of our tissue samples indenedantly; in this case 4 samples across 2 slides. But first, just test one.
...
If you see the following error - try a workaround, using a customised version of this that avoids the issue in just this dataset. The custom version, may be found [here](https://github.com/swbioinf/spatialsnippets/blob/main/code/spatially_variable_features_code.R)
...
Ttr had a higher  MoransI score in sample4 than sample1. Plotting its distribution in both demonstrates the difference - a very high expression region in sample4. 
