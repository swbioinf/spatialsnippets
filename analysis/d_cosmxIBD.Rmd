...
(FIX SPELLING IN OBJECT) of CHRONES
...
```{r}
dataset_dir      <- '~/data_local/datasets/'
...
sample_codes <- c(HC="Healthy controls",UC="Ulcerative colitis",CD="Chrones's disease")
