...
NB: The LoadNanostring.X function workaround is in the [LoadNanostring.R script](https://github.com/swbioinf/spatialsnippets/blob/main/code/LoadNanostring.R) in the code directory of this repo. See [Seurat ticket](https://github.com/satijalab/seurat/discussions/9261).
