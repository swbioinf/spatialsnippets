...
* Training developors: This material is [open](analysis/licence.html) and can be readily adapted for training - see [here](https://github.com/swbioinf/intro-spatial-transcriptomics-workshop) and [here](https://github.com/swbioinf/spatial-taster-workshop). Get in touch if you'd like to discuss. 
