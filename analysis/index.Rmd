...
Spatial sampler is instead a collection of How-Tos framed around testing specific biological questions – i.e. comparative tests between experimental conditions. 

Each HowTo includes:

* A **worked example** using a real dataset, which explains why each step is necessary
