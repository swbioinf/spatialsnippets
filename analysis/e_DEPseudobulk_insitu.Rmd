---
title: "Differential expression between groups using pseudobulk (with pseudoreplicates)"
...
* **fov** : column containing the cosmx 'fov' number (not the suerat FOV which corresponds to the whole slide). 
