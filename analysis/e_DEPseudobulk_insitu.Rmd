...
Note that there are other approaches to calculate differential expression in this kind of data - including those that make use of individual cells. <LINK A REVIEW>
