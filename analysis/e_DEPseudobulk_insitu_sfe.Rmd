...
#sfe <- sfe[,sample(1:ncol(sfe), 10000)]
```
...
## Deciding on pseudobulk grouping

<!-- # ```{r} -->
<!-- # plotSpatialFeature(sfe[,sfe$tissue_sample == "HC_a"], "celltype_subset",colGeometryName = "cellSeg") +  -->
...
## Cell filtering and counting (NEW)
